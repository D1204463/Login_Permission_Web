                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <div class="dropdown pb-4">
                        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            </svg>                            <!-- <img src="https://github.com/mdo.png" alt="hugenerd" width="30" height="30" class="rounded-circle"> -->
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li class="nav-item">
                            <a href="#" class="nav-link align-middle px-0">
                              ...
                              <span class="ms-1 d-none d-sm-inline">主頁面</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="#submenu1" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                              ...
                              <span class="ms-1 d-none d-sm-inline">業務部</span> </a>
                        ...
                        <li>
                            <a href="#" class="nav-link px-0 align-middle">
                              ...
                              <span class="ms-1 d-none d-sm-inline">信託部</span>
                            </a>
                        </li>
                        <li>
                            <a href="#submenu2" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                              ...
                              <span class="ms-1 d-none d-sm-inline">營業部</span></a>
                        ...
                        <li>
                            <a href="#submenu3" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                              ...
                              <span class="ms-1 d-none d-sm-inline">外匯部</span> </a>
                        ...
                        <li>
                            <a href="#" class="nav-link px-0 align-middle">
                              ...
                              <span class="ms-1 d-none d-sm-inline">消金部</span>
                            </a>
                        </li>
                        <li>
                            <a href="#submenu4" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                              ...
                              <span class="ms-1 d-none d-sm-inline">資訊部</span></a>
                        ...
                        <li>
                            <a href="#submenu5" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                              ...
                              <span class="ms-1 d-none d-sm-inline">人資部</span></a>
                        ...
                        <li>
                            <a href="#submenu6" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                              ...
                              <span class="ms-1 d-none d-sm-inline">財務部</span></a>
                        ...
                        <li>
                            <a href="#submenu7" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                              ...
                              <span class="ms-1 d-none d-sm-inline">總務部</span></a>
