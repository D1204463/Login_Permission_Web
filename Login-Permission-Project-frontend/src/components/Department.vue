                                                ...
                                                <select class="form-select" id="departmentSelect"
                                                 v-model="searchByDepartmentId"   >
                                                    ...
                                                    <option v-for="department in departmentOptions"
                                                        :key="department.department_id" :value="department.department_id">
                        ...
                        <tr v-for="department in filteredDepartments" v-bind:key="department.department_id">
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-link" data-bs-toggle="modal"
                                    data-bs-target="#editDepartmentModal" v-on:click="onUpdateDepartment(department)">
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-link text-danger" data-bs-toggle="modal"
                                    data-bs-target="#deleteDepartmentModal" v-on:click="onSelectDepartment(department)">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="addDepartmentName" v-model="newDepartment.department_name"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="addDepartmentCode" v-model="newDepartment.department_code"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="editDepartmentName" v-model="editDepartment.department_name"
                                aria-label="DepartmentName">
                        </div>
                    </div>
                    <!-- 部門代碼 Department Code -->
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="editDepartmentCode" v-model="editDepartment.department_code"
                                aria-label="DepartmentCode">
                        </div>
                    </div>
                    <div class="modal-footer">
