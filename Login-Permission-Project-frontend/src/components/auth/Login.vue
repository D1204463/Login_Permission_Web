  ...
  <div class="login-container">
    <div class="login-form bg-form rounded">
      ...
      <div class="user-icon text-center fade-in first">
        <font-awesome-icon icon="user-circle" size="5x" class="mb-4" />
      </div>
      ...
      <form @submit.prevent="handleLogin">
        ...
        <div class="mb-4 fade-in second">
          ...
          <div class="input-group">
            <input type="number" class="form-control" id="employeeId" v-model="employeeId" required>
          </div>
        </div>
        ...
        <div class="text-center fade-in fourth">
          <div class="d-flex justify-content-center gap-3">
            <button type="submit" class="btn lp-btn-outline" :disabled="isLoading" @click="handleLogin">
            ...
            <button type="button" class="btn lp-btn-outline" @click="handleRegister">
              註冊
            </button>
          </div>
        </div>
