    ...
    <div class="container">
        ...
        <div class="content-wrapper">
            <div class="row g-3 align-items-center">
                <!-- 新增狀態按鈕 -->
                <div class="col-auto">
                    <button type="button" class="btn add-status-btn" style="margin-bottom:20px;"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" v-on:click="createStatus">新增</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
                        <button type="button" class="btn btn-warning" data-bs-dismiss="modal" v-on:click="updateStatus">更新</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="deleteStatusModal" tabindex="-1" aria-labelledby="deleteStatusModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" v-on:click="deleteStatus">刪除</button>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        search() {
            ...
            this.statuses = this.statusOptions.filter(status => status.status_id == this.searchByStatusId);
        },
        resetSearch() {
        ...
        deleteStatus() {
            fetch(`http://localhost:8085/status/test/delete/${this.selectedStatus.status_id}`, {
                method: "DELETE"
            }).then(this.fetchStatuses);
        }
    },
